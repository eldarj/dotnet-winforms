...
namespace eRestoraniUI.KorisniciForms
{
    public partial class VlasniciList : Form
    {
        ...
        private void pretragaByString()
        {
            ...
            lblUkupno.Text = String.Format(Messages.ukupno_type_number, "vlasnika", vlasniciBindingList.Count);
        }
        ...
        private async void btnIzbrisi_Click(object sender, EventArgs e)
        {
            ...
            if (k != null)
            {
                var potvrda = MessageBox.Show(String.Format(Messages.izbrisi_obj_potvrda, k.ImePrezime),
                    String.Format(Messages.izbrisi_obj_potvrda_title, "vlasnika"),
                ...
                if (potvrda == DialogResult.Yes)
                {
                    ...
                    if (response.IsSuccessStatusCode)
                    {
                        MessageBox.Show(String.Format(Messages.uspjeh_delete_obj, "vlasnika " + k.ImePrezime),
            ...
            {
                MessageBox.Show(Messages.morate_odabrati_msg_obj, "vlasnika");
            }
            UIHelper.LoaderImgStackHide(ref imgLoader, ref loaderImgStack);
        }
